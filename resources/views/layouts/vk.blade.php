...
<head>
    ...
    <meta content="Valera Malikov" name="author"/>
        ...
        <div class="container-fluid">
            ...
            <div class="top-nav ">
                <ul class="nav pull-right top-menu" >
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img width="29" height="29" src="{{$user->getAvatar()}}" alt="">
    ...
    <div id="sidebar" class="nav-collapse collapse">
        ...
        <ul class="sidebar-menu">
            <li class="{{Request::is('/') ? 'active' : '' }}">
                <a href="{{url('/')}}"><span class="icon-box"><i class="icon-user"></i></span> Главная</a>
            </li>
            <li class="has-sub {{Request::segment(1)=='fk' ? 'active' : '' }}">
                <a href="javascript:;" class="">
                    <span class="icon-box"> <i class="icon-search"></i></span> Ищу.Киев
                    <span class="arrow"></span>
                </a>
                <ul class="sub">
